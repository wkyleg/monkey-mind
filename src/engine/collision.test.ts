...
describe('CollisionSystem', () => {
  ...
  describe('checkGroups', () => {
    it('should call callback for each collision', () => {
      const players = [
        new Entity(0, 0, 'player').setCollider({ type: 'circle', radius: 10 }),
      ];
      const enemies = [
    ...
    it('should not call callback for non-collisions', () => {
      ...
      const groupB = [
        new Entity(100, 100, 'enemy').setCollider({ type: 'circle', radius: 10 }),
      ];
...
describe('Game Scenario Tests', () => {
  ...
  it('should detect projectile hitting enemy', () => {
    const projectile = new Entity(100, 200, 'projectile')
      .setCollider({ type: 'circle', radius: 5 });
    
    const enemy = new Entity(102, 200, 'enemy')
      .setCollider({ type: 'circle', radius: 20 });
  ...
  it('should detect player collecting powerup', () => {
    const player = new Entity(200, 500, 'player')
      .setCollider({ type: 'aabb', width: 40, height: 50 });
    
    const powerup = new Entity(210, 510, 'pickup')
      .setCollider({ type: 'circle', radius: 15 });
  ...
  it('should handle multiple simultaneous collisions', () => {
    const player = new Entity(200, 200, 'player')
      .setCollider({ type: 'circle', radius: 20 });
