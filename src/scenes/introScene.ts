...
const STORY_PAGES: StoryPage[] = [
  ...
  },
  {
    title: 'THE ESCAPE',
    text: [
      'Eight acts of consciousness stand between you and freedom.',
      '',
      'From ESCAPE — breaking free of their control...',
      'Through OCEAN, HEROIC, SACRED, and PAINTED...',
      'Past LIBRARY and MACHINE...',
      'To the final SIGNALS — where true freedom awaits.',
      '',
      'Each layer deeper into your own mind.',
    ],
    duration: 9,
  },
  {
...
export class IntroScene extends Scene {
  ...
  render(renderer: Renderer, _alpha: number): void {
    ...
    // Title
    renderer.glowText(page.title, width / 2, height * 0.25, CONFIG.COLORS.PRIMARY, 36, 'center', 25);
    ...
    renderer.text(pageIndicator, width / 2, height * 0.85, CONFIG.COLORS.TEXT_DIM, 14, 'center');

    // Skip hint
    if (this.skipHintVisible) {
      renderer.text('SPACE TO CONTINUE • ESC TO SKIP', width / 2, height * 0.92, CONFIG.COLORS.TEXT_DIM, 12, 'center');
    }
